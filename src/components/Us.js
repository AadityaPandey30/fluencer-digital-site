      ...
      <section aria-labelledby="why-us" style={{ paddingTop: "8%" }}>
        ...
        >
          <div className="cont">
              <h1
                id="why-us"
                className="h3title-Us"
                style={{ color: "white", fontSize: "2.75rem" }}
              >
                Why Us
              ...
              {[
                {
                  ...
                  description:
                    "We handle every aspect of the project, from requirements gathering to deployment, ensuring a smooth process.",
                },
                {
                  number: "02",
                  title: "On-Time Delivery",
                  description:
                    "Our commitment to excellence ensures timely delivery, keeping you competitive in the digital landscape.",
                },
                {
                  number: "03",
                  title: "Latest Technology",
                  description:
                    "Leveraging cutting-edge technology, we deliver solutions that drive success and competitiveness.",
                },
                {
                  number: "04",
                  title: "24/7 Support",
                  description:
                    "Our team provides round-the-clock support, ensuring assistance whenever needed.",
                },
              ].map((item, index) => (
                <div key={index} className="para1 my-3 mx-4">
                  ...
                  <span className="span-Us" style={{ color: "gray" }}>
                    {item.description}
                  </span>
                </div>
              ))}
          ...
          <div
            className="secondContent container"
          ...
          >
            ...
            >
              ...
              <span style={{ color: "orangered", fontSize: "20px" }}>.</span>
            </h2>
                  ...
                  (tab, idx) => (
                    <li key={tab} className="nav-item">
                      <NavLink
                        ...
                        aria-current={
                          showTab === `tab${idx + 1}` ? "page" : undefined
                        }
                      >
                        {tab}
                      </NavLink>
